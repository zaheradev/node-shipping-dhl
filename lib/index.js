...
function splitter(str, l){
  ...
  function buildShipXML (data) {
    ...
    splitter(data.receiver.address, 44).slice(0,3).forEach(function (line) {
    ...
    // xml = concatKeyValuePair(xml, 'ProductContentCode', 'DOX');
    // xml = concatKeyValuePair(xml, 'ProductShortName', 'EXPRESS WORLDWIDE');
    exportDeclaration = [];
